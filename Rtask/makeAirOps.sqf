...
//	
//	_markertrack = createMarker ["trackmarker", getPos _truck1];
//	_markertrack setMarkerType "mil_triangle";
//	_markertrack setMarkerSize [0.6,0.6];
//	
//	_null = [_truck1,"trackmarker"] execVM "scripts\markertrack.sqf";
