...
player createDiaryRecord [
	...
	[
		...
		<br/>To SpyderBlack723 for his work for ArmA community and his superb Civilian Interaction Module,
...
player createDiaryRecord [
	...
	[
		"SUPPORT", 
		"<br/>It has some support elements deployed in Loy Manara AB, for use with Combat Support Tablet,
		<br/><br/>VECTOR ONE and VECTOR TWO for maneuver support,
		<br/>SCIMITAR ONE for CAS,
		<br/>STEEL RAIN ONE for Artillery Fire Support,
		<br/>The Commander asistant/UAV CCT can deploy UAVs or UGVs from <marker name='command'>here</marker>
		<br/>You can perform HALO Jump from <marker name='command_2'>here</marker>."
	]
];
